"""Python-side generator wrapper around Redis.scan(cursor=).
...
Both helpers are attached to Redis via __init__.py monkey-patch
...
if TYPE_CHECKING:
    ...
    from redis_rs_py._driver import Redis
