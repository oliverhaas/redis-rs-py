...
use crate::helpers::{py_bytes_list, py_int, py_opt_bytes};
...
impl Redis {
    ...
    fn lpush(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<i64> {
        crate::sync_op!(py, self, conn, async { conn.lpush(name, &values).await })
            .map_err(to_py_err)
    }
    ...
    fn rpush(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<i64> {
        crate::sync_op!(py, self, conn, async { conn.rpush(name, &values).await })
            .map_err(to_py_err)
    }
    ...
    fn lpushx(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<i64> {
        crate::sync_op!(py, self, conn, async { conn.lpushx(name, &values).await })
            .map_err(to_py_err)
    }
    ...
    fn rpushx(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<i64> {
        crate::sync_op!(py, self, conn, async { conn.rpushx(name, &values).await })
            .map_err(to_py_err)
    }
    ...
    fn llen(&self, py: Python<'_>, name: &str) -> PyResult<i64> {
        crate::sync_op!(py, self, conn, async { conn.llen(name).await }).map_err(to_py_err)
    }
    ...
    fn lpos(
        ...
        match count {
            None => {
                let r: redis::RedisResult<Option<i64>> = crate::sync_op!(py, self, conn, async {
            ...
            Some(c) => {
                let r: redis::RedisResult<Vec<i64>> = crate::sync_op!(py, self, conn, async {
    ...
    fn ltrim(&self, py: Python<'_>, name: &str, start: i64, end: i64) -> PyResult<()> {
        crate::sync_op!(py, self, conn, async { conn.ltrim(name, start, end).await })
            .map_err(to_py_err)
    }
...
impl AsyncRedis {
    ...
    #[pyo3(signature = (name, *values))]
    fn lpush(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<Py<PyAny>> {
    ...
    #[pyo3(signature = (name, *values))]
    fn rpush(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        crate::async_op!(self, py, conn, async {
    ...
    #[pyo3(signature = (name, *values))]
    fn lpushx(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        crate::async_op!(self, py, conn, async {
    ...
    #[pyo3(signature = (name, *values))]
    fn rpushx(&self, py: Python<'_>, name: &str, values: Vec<Vec<u8>>) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        crate::async_op!(self, py, conn, async {
    ...
    fn lrem(&self, py: Python<'_>, name: &str, count: i64, value: &[u8]) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        let value = value.to_vec();
        crate::async_op!(self, py, conn, async {
    ...
    fn lset(&self, py: Python<'_>, name: &str, index: i64, value: &[u8]) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        let value = value.to_vec();
        crate::async_op!(self, py, conn, async {
    ...
    fn ltrim(&self, py: Python<'_>, name: &str, start: i64, end: i64) -> PyResult<Py<PyAny>> {
        let name = name.to_string();
        crate::async_op!(self, py, conn, async {
